...
export default class Controller {
  ...
  onSubmit(e) {
    ...
    if(!this._model._editMode) {
      ...
      this._model.updateNote(updatedNote);
      this.updateNoteContent(this._model._editTodo.id, updatedNote);
  ...
  editNote(note) {
    ...
    console.log(this._model._editMode);
    console.log(note);
    if(this._model._editMode) {
  ...
  updateNoteContent(id, updatedContent) {
     ...
     */
    let updatedNote;
    this._model.notes = this._model._notes.map(el => {
  ...
  deleteNote(id) {
     ...
     * Возвращает: ничего
     */
    this._model.notes = this._model.notes.filter(el => el.id !== id);
  }

  findNoteById(id) {
    return this._model.notes.find(el => el.id === id);
  }
